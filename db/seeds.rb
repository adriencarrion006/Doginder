...
User.destroy_all
user1 = User.create!(email:"super@gmail.com", password:"lechien", pseudo: "Adri", first_name: "Adrien", last_name: "Carrion", image_avatar: "adri.jpg", description: "Nouveau sur l'appli, hâte de me faire des potes !")
...
user3 = User.create!(email:"miss@gmail.com", password:"lechien", pseudo: "Marinette", first_name: "Marine", last_name: "PITERIA", image_avatar: "Marine.jpg", description: "Je suis toujours de bonne humeur")
...
user19 = User.create!(email:"m@gmail.com", password:"lechien", pseudo: "Damssss", first_name: "Damien", last_name: "Desparain", image_avatar: "dam.jpg", description: "Je suis sympathique, selon les jours")
...
dogs1 = Dog.create!(user_id: user16.id, name: "Romeo", breed:"Croisé / Fox terrier poil dur", centre_interet:"Manger", fontawesome:"fas fa-utensils", description:"Roméo est un gentil petit loulou très joueur et affectueux !",location_cp:"06400")
dogs1.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1655818349/romeo-1_ot6pyn.jpg"), filename: "romeo-1.jpg", content_type: "image/jpg")
dogs1.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1655818350/romeo-2_dwc1hw.jpg"), filename: "romeo-2.jpg", content_type: "image/jpg")
dogs1.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1655818350/romeo-3_wxjee4.jpg"), filename: "romeo-3.jpg", content_type: "image/jpg")

dogs2 = Dog.create!(user_id: user3.id, name: "Beethoven", breed:"Saint-Bernard", centre_interet:"Parcours d'agilité", fontawesome:"fas fa-running", description:"il mange trop de croquettes",location_cp:"06400")
...
dogs3 = Dog.create!(user_id: user4.id, name: "Rantanplan", breed:"malinoi", centre_interet:"Nager", fontawesome:"fas fa-swimmer", description:"trés fidéle",location_cp:"06100")
...
dogs4 = Dog.create!(user_id: user10.id, name: "Croc-Blanc", breed:"loup", centre_interet:"Poursuivre le facteur ", fontawesome:"fas fa-mail-bulk", description:"il aime jouer dans la neige",location_cp:"06400")
...
dogs5 = Dog.create!(user_id: user6.id, name: "Bella-Chao", breed:"loupHusky siberien", centre_interet:"Ronger mon nonos", fontawesome:"fas fa-bone", description:"Elle porte bien son nom, Bella est très belle mais aussi très gentille et joueuse.",location_cp:"06400")
...
dogs6 = Dog.create!(user_id: user7.id, name: "Caramel", breed:"Bouledogue Américain", centre_interet:"Jouer à la baballe", fontawesome:"fas fa-basketball-ball", description:"Caramel est un grand garçon, tout en force !
...
dogs7 = Dog.create!(user_id: user8.id, name: "Cricket", breed:"Croisé / Autre", centre_interet:"Faire la sieste", fontawesome:"fas fa-bed", description:"Cricket est un chien qui peut se montrer un peu timide au départ et assez câlin une fois qu'il connait.
...
dogs8 = Dog.create!(user_id: user9.id, name: "Ewelina", breed:"Berger", centre_interet:"Poursuivre le facteur ", fontawesome:"fas fa-mail-bulk", description:"Ewelina est une chienne sensible",location_cp:"06400")
...
dogs9 = Dog.create!(user_id: user8.id, name: "Harlem", breed:"loup", centre_interet:"Chasser les chats", fontawesome:"fas fa-cat", description:"Harlem se montre très proche de l'humain, câlin, en demande d'attention et hyper attendrissant.",location_cp:"06300")
...
dogs10 = Dog.create!(user_id: user10.id, name: "Hijo", breed:"croisé ", centre_interet:"Faire la sieste", fontawesome:"fas fa-bed", description:"Hijo a énormément de mal à faire confiance aux humains. Craintif, méfiant, il aura besoin de temps et d'une approche très douce pour se révéler sous son vrai jour.
...
dogs11 = Dog.create!(user_id: user11.id, name: "Jany", breed:"American staffordshire", centre_interet:"Ronger mon nonos", fontawesome:"fas fa-bone", description:"Jany est un jeune chienne, dynamique et affectueuse.
...
dogs13 = Dog.create!(user_id: user13.id, name: "Magnum", breed:"Drahthaar", centre_interet:"Manger", fontawesome:"fas fa-utensils", description:"Magnum s'entend avec ses congénères mais il a ses têtes. Il ne s'entend pas avec les chats.
...
dogs14 = Dog.create!(user_id: user14.id, name: "Nicky", breed:"Croisé / Dogue argentin", centre_interet:"Manger", fontawesome:"fas fa-utensils", description:"Nicky est un chien affectueux, qui aime son confort et qui a toujours envie d'apprendre et de faire plaisir.
...
dogs15 = Dog.create!(user_id: user15.id, name: "Odda", breed:"Braque", centre_interet:"Canicross", fontawesome:"fas fa-running", description:"Odda est un chien très dynamique à qui il faudra apprendre à se canaliser en méthode positive. Il aura besoin d'être énormément dépensé, autant physiquement qu'intellectuellement, au risque de rencontrer des problèmes de comportement.",location_cp:"06400")
...
dogs16 = Dog.create!(user_id: user2.id, name: "Lassie", breed:"border collie", centre_interet:"Courir en montagne", fontawesome:"fas fa-mountain", description:"Super gentille, joueuse, j'adore me ballader dans la nature",location_cp:"06400")
dogs16.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1655736985/lassie2_mgtcws.jpg"), filename: "lassie.jpg", content_type: "image/jpg")
dogs16.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1655736985/lassie_uwonum.jpg"), filename: "lassi2.jpg", content_type: "image/jpg")
dogs16.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1655736986/lassie3_ebumgj.jpg"), filename: "lassie3.jpg", content_type: "image/jpg")

dogs17 = Dog.create!(user_id: user5.id, name: "Titounet", breed:"Berger", centre_interet:"Courir en montagne", fontawesome:"fas fa-mountain", description:"Titounet est un chien qui a encore beaucoup à apprendre. Très dynamique et joueur.",location_cp:"06400")
...
dogs18 = Dog.create!(user_id: user18.id, name: "Bayron", breed:"croisé", centre_interet:"Courir en montagne", fontawesome:"fas fa-mountain", description:"Bayron n'est pas un papy tranquille, monsieur a encore énormément d'énergie à revendre !",location_cp:"06400")
...
dogs19 = Dog.create!(user_id: user19.id, name: "Nina", breed:"berger australien", centre_interet:"Courir en montagne", fontawesome:"fas fa-mountain", description:"Ce superbe chien (oui oui c'est une vraie beauté !), très dynamique et joueuse, a cependant peur des chiens plus grands qu'elle !",location_cp:"06400")
dogs19.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1656003162/nina1_anhh9h.jpg"), filename: "ninou-1.jpg", content_type: "image/jpg")
dogs19.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1656003162/nina3_jaiqxj.jpg"), filename: "ninou-2.jpg", content_type: "image/jpg")
dogs19.photos.attach(io: URI.open("https://res.cloudinary.com/dcluutgvi/image/upload/v1656003162/nina2_diosoo.jpg"), filename: "ninou-3.jpg", content_type: "image/jpg")
