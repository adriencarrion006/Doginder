...
dogs = Dog.create!(user_id: user9.id, name: "rex", breed:"berger allemand", centre_interet:"manger", description:"il fouille partout",location_cp:"06400")
...
dogs9 = Dog.create!(user_id: user9.id, name: "Harlem", breed:"loup", centre_interet:"Canicross", description:"Harlem se montre très proche de l'humain, câlin, en demande d'attention et hyper attendrissant.",location_cp:"06300")
